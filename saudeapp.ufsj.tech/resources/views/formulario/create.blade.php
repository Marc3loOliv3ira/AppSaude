        ...
        <div id="form-create-container" class="col-md-6 offset-md-3">
            ...
            <form enctype="multipart/form-data" name="form_fisico">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name='sisUrologico_perdaDeUrinaTosseEspirraCarregaPesoRi' value='sim' {{ old('sisUrologico_perdaDeUrinaTosseEspirraCarregaPesoRi') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_perdaDeUrinaTosseEspirraCarregaPesoRi' value='nao' {{ old('sisUrologico_perdaDeUrinaTosseEspirraCarregaPesoRi') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Perda de urina quando tem uma vontade urgente de ir ao banheiro?</p>
                    <input type="radio" name='sisUrologico_perdaUrinaVontadeDeIrNoBanheiro' value='sim' {{ old('sisUrologico_perdaUrinaVontadeDeIrNoBanheiro') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_perdaUrinaVontadeDeIrNoBanheiro' value='nao' {{ old('sisUrologico_perdaUrinaVontadeDeIrNoBanheiro') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Frequência urinário por dia</p>
                    <input type="text" class="form-control" name="sisUrologico_frequenciaUrinaria" value="{{ old('sisUrologico_frequenciaUrinaria') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="transparente" {{ old('sisUrologico_coloracao') == "transparente" ? 'checked' : '' }}>
                                <label>transparente</label>
                            </td>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="amarela claro" {{ old('sisUrologico_coloracao') == "amarela claro" ? 'checked' : '' }}>
                                <label>amarela claro</label>
                            </td>
                        </tbody>
                        <tbody>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="amarela âmbar" {{ old('sisUrologico_coloracao') == "amarela âmbar" ? 'checked' : '' }}>
                                <label>amarela âmbar</label>
                            </td>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="laranja" {{ old('sisUrologico_coloracao') == "laranja" ? 'checked' : '' }}>
                                <label>laranja</label>
                            </td>
                        </tbody>
                        <tbody>
                            <td>
                                <input type="radio" name=sisUrologico_coloracao" value="rósea/avermelhada" {{ old('sisUrologico_coloracao') == "rósea/avermelhada" ? 'checked' : '' }}>
                                <label>rósea/avermelhada </label>
                            </td>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="acastanhada" {{ old('sisUrologico_coloracao') == "acastanhada" ? 'checked' : '' }}>
                                <label>acastanhada</label>
                            </td>
                        </tbody>
                        <tbody>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="esverdeada/azulada" {{ old('sisUrologico_coloracao') == "esverdeada/azulada" ? 'checked' : '' }}>
                                <label>esverdeada/azulada</label>
                            </td>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="hemática" {{ old('sisUrologico_coloracao') == "hemática" ? 'checked' : '' }}>
                                <label>hemática</label>
                            </td>
                        </tbody>
                        <tbody>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="espumosa" {{ old('sisUrologico_coloracao') == "espumosa" ? 'checked' : '' }}>
                                <label>espumosa</label>
                            </td>
                            <td>
                                <input type="radio" name="sisUrologico_coloracao" value="piúria" {{ old('sisUrologico_coloracao') == "piúria" ? 'checked' : '' }}>
                                <label>piúria</label>
                            </td>
                        </tbody>
                    </table>
                ...
                <div class="form-group">
                    <p>Noctúria</p>
                    <input type="radio" name='sisUrologico_nocturia' value='sim' {{ old('sisUrologico_nocturia') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_nocturia' value='nao' {{ old('sisUrologico_nocturia') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>

                    <input type="text" name="sisUrologico_nocturia_qtd" class="form-control" placeholder="Se sim, quantas vezes por dia?">
                </div>

                <div class="form-group">
                    <p>Perda de urina durante o sexo</p>
                    <input type="radio" name='sisUrologico_perdaUrinaDuranteSexo' value='sim' {{ old('sisUrologico_perdaUrinaDuranteSexo') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_perdaUrinaDuranteSexo' value='nao' {{ old('sisUrologico_perdaUrinaDuranteSexo') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Uso de proteção (absorventes, panos, etc)</p>
                    <input type="radio" name='sisUrologico_usoProtecao' value='sim' {{ old('sisUrologico_usoProtecao') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_usoProtecao' value='nao' {{ old('sisUrologico_usoProtecao') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Esvaziamento incompleto da bexiga</p>
                    <input type="radio" name='sisUrologico_esvaziamentoIncompleto' value='sim' {{ old('sisUrologico_esvaziamentoIncompleto') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_esvaziamentoIncompleto' value='nao' {{ old('sisUrologico_esvaziamentoIncompleto') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Esforço para urinar</p>
                    <input type="radio" name='sisUrologico_esforcoParaUrinar' value='sim' {{ old('sisUrologico_esforcoParaUrinar') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_esforcoParaUrinar' value='nao' {{ old('sisUrologico_esforcoParaUrinar') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Odor de ureia</p>
                    <input type="radio" name='sisUrologico_odorUreia' value='sim' {{ old('sisUrologico_odorUreia') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_odorUreia' value='nao' {{ old('sisUrologico_odorUreia') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Urgência para usar o banheiro</p>
                    <input type="radio" name='sisUrologico_urgenciaParaBanheiro' value='sim' {{ old('sisUrologico_urgenciaParaBanheiro') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_urgenciaParaBanheiro' value='nao' {{ old('sisUrologico_urgenciaParaBanheiro') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Dor ao urinar</p>
                    <input type="radio" name='sisUrologico_dorAoUrinar' value='sim' {{ old('sisUrologico_dorAoUrinar') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_dorAoUrinar' value='nao' {{ old('sisUrologico_dorAoUrinar') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Dor renal</p>
                    <input type="radio" name='sisUrologico_dorRenal' value='sim' {{ old('sisUrologico_dorRenal') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_dorRenal' value='nao' {{ old('sisUrologico_dorRenal') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>

                <div class="form-group">
                    <p>Presença de globo vesical palpável</p>
                    <input type="radio" name='sisUrologico_globoVesicalPalpavel' value='sim' {{ old('sisUrologico_globoVesicalPalpavel') == "sim" ? 'checked' : '' }} />
                    <label>Sim</label>

                    <input type="radio" name='sisUrologico_globoVesicalPalpavel' value='nao' {{ old('sisUrologico_globoVesicalPalpavel') == "nao" ? 'checked' : '' }} />
                    <label>Não</label>
                </div>
...
function fisico(){
    document.getElementById('av_psicossocial-tab').click();
    window.scrollTo(0, 0);
}

function psicossocial(){
    document.getElementById('av_funcional-tab').click();
    window.scrollTo(0, 0);
}
</script>
...
<script>
    $(function(){
        $('form[name="form_fisico"]').submit(function(event){
    ...
    $(function(){
        $('form[name="form_psicossocial"]').submit(function(event){
            event.preventDefault();
    ...
    $(function(){
        $('form[name="form_funcional"]').submit(function(event){
            event.preventDefault();
